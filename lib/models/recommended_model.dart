...
List<RecommendedModel> recommendations = recommendationsData
    .map((item) => RecommendedModel(name: item['name']!.toString(), tagLine: item['tagLine'].toString(),
       image : item['image'].toString(),  images: item['images'] as List<String>, description : item['description'].toString(), price: item['price'] as int))
    .toList();
